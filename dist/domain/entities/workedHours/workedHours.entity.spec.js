...
// src/domain/entities/workedHours/workedHours.entity.spec.ts
describe("Employee Entity", () => {
  test("it must be possible to create Employee", () => {
    ...
    globalExpect(workedHours.employee_id).toBe("123e4567-e89b-12d3-a456-426614174000");
  });
  ...
  test("it must be possible to create WorkedHours", () => {
    ...
    const workedHours = new WorkedHours(props);
    globalExpect(workedHours.hours_worked).toBe("00h 00m");
  });
