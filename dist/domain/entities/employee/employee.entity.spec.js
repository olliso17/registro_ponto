    ...
    function printPlugin(plugin2, val, config2, indentation, depth, refs) {
      ...
      try {
        printed = isNewPlugin(plugin2) ? plugin2.serialize(val, config2, indentation, depth, refs, printer) : plugin2.print(
          ...
          (str2) => {
            const indentationNext = indentation + config2.indent;
            return indentationNext + str2.replace(NEWLINE_REGEXP, `
${indentationNext}`);
          },
          {
...
var require_expectTypes = __commonJS({
  "node_modules/chai/lib/chai/utils/expectTypes.js"(exports2, module2) {
    ...
    module2.exports = function expectTypes(obj, types) {
      ...
      types.sort();
      var str2 = types.map(function(t, index) {
...
var require_objDisplay = __commonJS({
  "node_modules/chai/lib/chai/utils/objDisplay.js"(exports2, module2) {
    ...
    module2.exports = function objDisplay2(obj) {
      var str2 = inspect3(obj), type2 = Object.prototype.toString.call(obj);
...
var require_assertions = __commonJS({
  "node_modules/chai/lib/chai/core/assertions.js"(exports2, module2) {
    ...
    module2.exports = function(chai3, _) {
      ...
      Assertion2.addMethod("string", function(str2, msg) {
        if (msg)
          flag(this, "message", msg);
        ...
        this.assert(
          ~obj.indexOf(str2),
          "expected #{this} to contain " + _.inspect(str2),
          "expected #{this} to not contain " + _.inspect(str2)
        );
      });
      function assertKeys(keys2) {
        var obj = flag(this, "object"), objType = _.type(obj), keysType = _.type(keys2), ssfi = flag(this, "ssfi"), isDeep = flag(this, "deep"), str2, deepStr = "", actual, ok = true, flagMsg = flag(this, "message");
        flagMsg = flagMsg ? flagMsg + ": " : "";
        ...
        if (len > 1) {
          ...
          str2 = _.inspect(keys2[0]);
        }
        str2 = (len > 1 ? "keys " : "key ") + str2;
        str2 = (flag(this, "contains") ? "contain " : "have ") + str2;
        this.assert(
          ok,
    ...
    Bundle = class _Bundle {
      ...
      toString() {
        const body = this.sources.map((source, i2) => {
          const separator = source.separator !== void 0 ? source.separator : this.separator;
          const str2 = (i2 > 0 ? separator : "") + source.content.toString();
          return str2;
        }).join("");
...
function objDisplay(obj, options = {}) {
  if (typeof options.truncate === "undefined")
    options.truncate = 40;
  const str2 = inspect2(obj, options);
  const type2 = Object.prototype.toString.call(obj);
  if (options.truncate && str2.length >= options.truncate) {
    if (type2 === "[object Function]") {
      const fn2 = obj;
...
var naturalCompare = function(a, b2) {
  ...
  function getCode(str2, pos, code) {
    if (code) {
      for (i2 = pos; code = getCode(str2, i2), code < 76 && code > 65; )
        ++i2;
      return +str2.slice(pos - 1, i2);
    }
    code = alphabet && alphabet.indexOf(str2.charAt(pos));
    return code > -1 ? code + 76 : (code = str2.charCodeAt(pos) || 0, code < 45 || code > 127) ? code : code < 46 ? 65 : code < 48 ? code - 1 : code < 58 ? code + 18 : code < 65 ? code - 11 : code < 91 ? code + 11 : code < 97 ? code - 37 : code < 123 ? code + 5 : code - 63;
  }
  if ((a += "") != (b2 += ""))
    for (; codeB; ) {
...
function escapeBacktickString(str2) {
  return str2.replace(/`|\\|\${/g, "\\$&");
}
function printBacktickString(str2) {
  return `\`${escapeBacktickString(str2)}\``;
}
...
function withGlobal(_global) {
  ...
  function parseTime(str2) {
    if (!str2) {
      return 0;
    }
    const strings = str2.split(":");
    const l = strings.length;
    let i2 = l;
    let ms = 0;
    let parsed;
    if (l > 3 || !/^(\d\d:){0,2}\d\d?$/.test(str2)) {
      throw new Error(
    ...
    while (i2--) {
      ...
      if (parsed >= 60) {
        throw new Error(`Invalid time ${str2}`);
      }
...
// src/domain/entities/employee/employee.entity.spec.ts
describe("Employee Entity", () => {
  test("it must be possible to create Employee", () => {
    ...
    globalExpect(employee).toHaveProperty("id");
    globalExpect(employee.name).toBe("Patricia");
  });
