    ...
    function printPlugin(plugin2, val, config2, indentation, depth, refs) {
      ...
      try {
        printed = isNewPlugin(plugin2) ? plugin2.serialize(val, config2, indentation, depth, refs, printer) : plugin2.print(
          ...
          (str3) => {
            const indentationNext = indentation + config2.indent;
            return indentationNext + str3.replace(NEWLINE_REGEXP, `
${indentationNext}`);
          },
          {
...
var require_pathval = __commonJS({
  "node_modules/pathval/index.js"(exports2, module2) {
    ...
    function parsePath(path2) {
      var str3 = path2.replace(/([^\\])\[/g, "$1.[");
      var parts = str3.match(/(\\\.|[^.]+?)+/g);
...
var require_expectTypes = __commonJS({
  "node_modules/chai/lib/chai/utils/expectTypes.js"(exports2, module2) {
    ...
    module2.exports = function expectTypes(obj, types) {
      ...
      types.sort();
      var str3 = types.map(function(t, index) {
      ...
      if (!types.some(function(expected) {
        ...
        throw new AssertionError2(
          flagMsg + "object tested must be " + str3 + ", but " + objType + " given",
          void 0,
          ssfi
        );
      }
...
var require_objDisplay = __commonJS({
  "node_modules/chai/lib/chai/utils/objDisplay.js"(exports2, module2) {
    ...
    module2.exports = function objDisplay2(obj) {
      var str3 = inspect3(obj), type2 = Object.prototype.toString.call(obj);
      if (config2.truncateThreshold && str3.length >= config2.truncateThreshold) {
...
var require_assertions = __commonJS({
  "node_modules/chai/lib/chai/core/assertions.js"(exports2, module2) {
    ...
    module2.exports = function(chai3, _) {
      ...
      Assertion2.addMethod("string", function(str3, msg) {
        if (msg)
          flag(this, "message", msg);
        ...
        this.assert(
          ~obj.indexOf(str3),
          "expected #{this} to contain " + _.inspect(str3),
          "expected #{this} to not contain " + _.inspect(str3)
        );
      });
      function assertKeys(keys2) {
        var obj = flag(this, "object"), objType = _.type(obj), keysType = _.type(keys2), ssfi = flag(this, "ssfi"), isDeep = flag(this, "deep"), str3, deepStr = "", actual, ok = true, flagMsg = flag(this, "message");
        flagMsg = flagMsg ? flagMsg + ": " : "";
        ...
        if (len > 1) {
          ...
          var last = keys2.pop();
          if (all) {
            str3 = keys2.join(", ") + ", and " + last;
          }
          if (any) {
            str3 = keys2.join(", ") + ", or " + last;
          }
        } else {
          str3 = _.inspect(keys2[0]);
        }
        str3 = (len > 1 ? "keys " : "key ") + str3;
        str3 = (flag(this, "contains") ? "contain " : "have ") + str3;
        this.assert(
          ok,
          "expected #{this} to " + deepStr + str3,
          "expected #{this} to not " + deepStr + str3,
...
function getBtoa() {
  if (typeof globalThis !== "undefined" && typeof globalThis.btoa === "function") {
    return (str3) => globalThis.btoa(unescape(encodeURIComponent(str3)));
  } else if (typeof Buffer === "function") {
    return (str3) => Buffer.from(str3, "utf-8").toString("base64");
  } else {
    return () => {
  ...
  "node_modules/magic-string/dist/magic-string.es.mjs"() {
    ...
    MagicString = class _MagicString {
      ...
      _replaceRegexp(searchValue, replacement) {
        function getReplacement(match, str3) {
          if (typeof replacement === "string") {
            ...
            return replacement(...match, match.index, str3, match.groups);
          }
        }
        function matchAll(re, str3) {
          let match;
          const matches = [];
          while (match = re.exec(str3)) {
            matches.push(match);
          }
          return matches;
        }
    ...
    Bundle = class _Bundle {
      ...
      prepend(str3) {
        this.intro = str3 + this.intro;
        return this;
      }
      toString() {
        const body = this.sources.map((source, i2) => {
          const separator = source.separator !== void 0 ? source.separator : this.separator;
          const str3 = (i2 > 0 ? separator : "") + source.content.toString();
          return str3;
        }).join("");
...
function format(...args) {
  ...
  let str3 = String(template).replace(formatRegExp, (x) => {
    if (x === "%%")
      return "%";
    if (i2 >= len)
      return x;
...
function objDisplay(obj, options = {}) {
  if (typeof options.truncate === "undefined")
    options.truncate = 40;
  const str3 = inspect2(obj, options);
  const type2 = Object.prototype.toString.call(obj);
  if (options.truncate && str3.length >= options.truncate) {
    if (type2 === "[object Function]") {
      const fn2 = obj;
...
var naturalCompare = function(a, b2) {
  ...
  function getCode(str3, pos, code) {
    if (code) {
      for (i2 = pos; code = getCode(str3, i2), code < 76 && code > 65; )
        ++i2;
      return +str3.slice(pos - 1, i2);
    }
    code = alphabet && alphabet.indexOf(str3.charAt(pos));
    return code > -1 ? code + 76 : (code = str3.charCodeAt(pos) || 0, code < 45 || code > 127) ? code : code < 46 ? 65 : code < 48 ? code - 1 : code < 58 ? code + 18 : code < 65 ? code - 11 : code < 91 ? code + 11 : code < 97 ? code - 37 : code < 123 ? code + 5 : code - 63;
  }
  if ((a += "") != (b2 += ""))
    for (; codeB; ) {
...
function escapeBacktickString(str3) {
  return str3.replace(/`|\\|\${/g, "\\$&");
}
function printBacktickString(str3) {
  return `\`${escapeBacktickString(str3)}\``;
}
...
function withGlobal(_global) {
  ...
  function parseTime(str3) {
    if (!str3) {
      return 0;
    }
    const strings = str3.split(":");
    const l = strings.length;
    let i2 = l;
    let ms = 0;
    let parsed;
    if (l > 3 || !/^(\d\d:){0,2}\d\d?$/.test(str3)) {
      throw new Error(
    ...
    while (i2--) {
      ...
      if (parsed >= 60) {
        throw new Error(`Invalid time ${str3}`);
      }
...
// src/infra/repositories/employee/employee.repository.spec.ts
describe("Employee Repository", () => {
  const employeeReppository = new employee_repository_default();
  test("not create employee", async () => {
    const name = "Raquel";
    await globalExpect(employeeReppository.createEmployee(name)).rejects.toThrow(new AppError("Name is not a valid employee"));
  });
});
